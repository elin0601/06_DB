...
SELECT 'HELLO WOLRD', LENGTH('HELLO WOLRD') FROM DUAL;
...
SELECT EMP_ID , EMP_NAME , HIRE_DATE,
	CEIL (MONTHS_BETWEEN(SYSDATE, HIRE_DATE)  / 12) || ' N년차' "N년차"
FROM EMPLOYEE;
...
SELECT SYSDATE , TO_CHAR(SYSDATE, 'YYYY"년" MM"월" DD"일" PM HH"시" MI"분" SS"초"')
FROM DUAL;
...
-- 숫자 -> 날짜
SELECT TO_DATE(20240227, 'YYYYMMDD')
FROM DUAL; -- 2024-02-27 00:00:00.000

...
-- DEFAULT (= 기본값) : 컬럼의 기본 값 지정 (필수 아님!!)
 --> INSERT, UPDATE 시 해당 컬럼의 값을 넣지 않으면 
 --> 지정한 기본 값이 들어간다!
...
-- ORA-01400: NULL을 ("KH_LJS"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
--> 무결성 제약 조건(KH_LJS.USER_ID_U)에 위배됩니다
...
--> USER_NO가 다름
-- ORA-00001: 무결성 제약 조건(KH_LJS.USER_ID_NAME_U)에 위배됩니다
...
--> 기본키 중복으로 오류
-- ORA-00001: 무결성 제약 조건(KH_LJS.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES(NULL, 'user03', 'pass03', '유관순', '여', '010-9999-3131', 'yoo123@kh.or.kr');
--> 기본키가 NULL 이므로 오류
-- ORA-01400: NULL을 ("KH_LJS"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
...
-- ORA-02291: 무결성 제약조건(KH_LJS.GRADE_CODE_FK1)이 위배되었습니다
-- - 부모 키가 없습니다
...
DELETE FROM USER_GRADE 
WHERE GRADE_CODE = 30;
-- ORA-02292: 무결성 제약조건(KH_LJS.GRADE_CODE_FK1)이 위배되었습니다
-- - 자식 레코드가 발견되었습니다
...
-- CHECK (컬럼명 비교연산자 비교값) 
-- 주의 : 비교값은 리터럴만 사용할 수 있음(딱 떨어지는 값만 사용 가능), 변하는 값이나 함수 사용 못함
...
-- ORA-02290: 체크 제약조건(KH_LJS.GENDER_CHECK)이 위배되었습니다

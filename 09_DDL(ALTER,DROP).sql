...
ALTER TABLE DEPT_COPY 
MODIFY LOCATION_ID CONSTRAINT SYS_C007548 NULL;
--> 컬럼명 작성 해줘야함
...
UPDATE DEPT_COPY SET LNAME = '대한민국'; -- 또는 DEFAULT
COMMIT;
...
--> 제약조건까지 모두 삭제 (종속 관계에 있는 제약 조건 모두 삭제)
